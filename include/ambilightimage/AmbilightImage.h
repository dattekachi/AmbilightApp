...
class AmbilightImage : public QObject
{
	Q_OBJECT

public:
	AmbilightImage();
	AmbilightImage(QSize size);
	~AmbilightImage();

	AmbilightImage(const AmbilightImage& t) = delete;
	AmbilightImage& operator=(const AmbilightImage& x) = delete;
